...
यह repository केवल **Mgboard Android keyboard** के आधिकारिक downloadable APK का public archive है। सॉर्स कोड अलग (private) repository में है और इस repository में source नहीं शामिल है।

## नवीनतम version

| Field | Value |
|---|---|
| Version | **0.1.17-share-download** (versionCode 20) |
...
पहले कीबोर्ड के Share बटन में सिर्फ GitHub profile का link था, जिससे दूसरे को APK download नहीं मिल पा रहा था। अब Share text में यही permanent link जाता है:

```
https://github.com/saiyyamdeveloper/Mgboard-Downloads/releases/latest
```

इसलिए जो भी नया version publish होता है, Share link अपने-आप उसी नए version पर ले जाता है — पुराना link कभी "भ्रामक पुराना" नहीं रहता।
...
### 0.1.17-share-download (versionCode 20) — 2026-09-20
- Share बटन अब public download page (यही repository) share करता है — receiver सीधे नया version install कर सकता है।
...
- Keyboard की height और key layout unchanged।
