...
1. **Share बटन में सीधा download link**: कीबोर्ड menu → Share पर अब सिर्फ यह एक working link जाता है:
   ...
   जो download link प्राप्तकर्ता को मिलता है वह हमेशा इसी repository का **Latest release** page है — अगला version publish होते ही वही link नया version देगा। Share text में सिर्फ यही एक working download link है।
...
- वास्तविक फोन/OEM apps में E2E अभी verify बाकी है; build में 96 Java unit + browser/native-mock automated checks पास हैं (share-link guard: सिर्फ public download link, private source link नहीं)।
