...
1. **Share बटन में सीधा download link**: कीबोर्ड menu → Share पर अब यह text जाता है:

   ```
   Mgboard Android — मासारम गोंडी कीबोर्ड (0.1.17)
   नया version यहाँ से download करके install करें:
   https://github.com/saiyyamdeveloper/Mgboard-Downloads/releases/latest
   ```

   जो link प्राप्तकर्ता को मिलता है वह हमेशा इसी repository का **Latest release** page है — अगला version publish होते ही वही link नया version देगा।
...
- वास्तविक फोन/OEM apps में E2E अभी verify बाकी है; build में 96 Java unit + browser/native-mock automated checks पास हैं।
